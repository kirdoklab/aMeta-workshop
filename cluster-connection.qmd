...
Mac systems also have a default support on the command line. The `terminal` application on your Mac system would be enough. But we advise you to install [iTerm2](https://iterm2.com/) as a `terminal` replacement for your Mac.
...
### Connecting to TRUBA system outside of the universiy network
...
The workshop folder will be like this:
