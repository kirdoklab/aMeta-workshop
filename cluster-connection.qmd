...
You should have been comfortable using the Unix/Linux command line to follow the course. We know that there will be several operating systems. So please check these reccomendations based on your operating system.
